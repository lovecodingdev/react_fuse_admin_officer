...
export const getLifes = createAsyncThunk(
	'income/lifeEntries/getProducts',
	() =>
...
export const saveProduct = createAsyncThunk('income/lifeEntry/saveProduct', async (product, { dispatch, getState }) => {
...
export const removeProducts = createAsyncThunk(
	'income/lifeEntries/removeProducts',
...
export const { selectAll: selectLifes, selectById: selectProductById } = productsAdapter.getSelectors(
	state => state.income.lifeEntries
);
