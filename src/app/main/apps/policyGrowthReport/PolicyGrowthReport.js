	...
	function updateData(temp) {
		...
		let percentRows = {
			'31-Dec': {
				...
				hhs: {
					...
					value: temp.January.hhs.value
						? percentValue(temp.January.hhs.value, temp['31-Dec'].hhs.value)
						: 0
				}
			},
			January: {
			...
			February: {
				...
				hhs: {
					...
					value: temp.February.hhs.value
						? percentValue(temp.February.hhs.value, temp.January.hhs.value)
						: 0
				}
			},
			March: {
				...
				total: {
					id: 'total',
					value: temp.March.total.value
						? percentValue(temp.March.total.value, temp.February.total.value)
						: 0
				},
				hhs: {
					id: 'hhs',
			...
			April: {
				...
				health: {
					id: 'health',
					value: temp.April.health.value
						? percentValue(temp.April.health.value, temp.March.health.value)
						: 0
				},
				total: {
					id: 'total',
			...
			August: {
				...
				health: {
					id: 'health',
					value: temp.August.health.value
						? percentValue(temp.August.health.value, temp.July.health.value)
						: 0
				},
				total: {
					id: 'total',
					value: temp.August.total.value
						? percentValue(temp.August.total.value, temp.July.total.value)
						: 0
				},
				hhs: {
					id: 'hhs',
			...
			September: {
				...
				hhs: {
					...
					value: temp.September.hhs.value
						? percentValue(temp.September.hhs.value, temp.August.hhs.value)
						: 0
				}
			},
			October: {
				...
				hhs: {
					...
					value: temp.October.hhs.value
						? percentValue(temp.October.hhs.value, temp.September.hhs.value)
						: 0
				}
			},
			November: {
				...
				hhs: {
					...
					value: temp.November.hhs.value
						? percentValue(temp.November.hhs.value, temp.October.hhs.value)
						: 0
				}
			},
			December: {
				...
				hhs: {
					...
					value: temp.December.hhs.value
						? percentValue(temp.December.hhs.value, temp.November.hhs.value)
						: 0
				}
			}
		};
		...
		let perHouseHoldRows = {
			...
			January: {
				...
				auto: {
					id: 'auto',
					value: temp.January.hhs.value
						? houseHoldValue(temp.January.auto.value, temp.January.hhs.value)
						: 0
				},
				fire: {
					id: 'fire',
					value: temp.January.hhs.value
						? houseHoldValue(temp.January.fire.value, temp.January.hhs.value)
						: 0
				},
				life: {
					id: 'life',
					value: temp.January.hhs.value
						? houseHoldValue(temp.January.life.value, temp.January.hhs.value)
						: 0
				},
				health: {
					id: 'health',
				...
				total: {
					id: 'total',
					value: temp.January.hhs.value
						? houseHoldValue(temp.January.total.value, temp.January.hhs.value)
						: 0
				}
			},
			February: {
			...
			August: {
				...
				health: {
					id: 'health',
					value: temp.August.hhs.value
						? houseHoldValue(temp.August.health.value, temp.August.hhs.value)
						: 0
				},
				total: {
					id: 'total',
					value: temp.August.hhs.value
						? houseHoldValue(temp.August.total.value, temp.August.hhs.value)
						: 0
				}
			},
			September: {
			...
			October: {
				...
				auto: {
					id: 'auto',
					value: temp.October.hhs.value
						? houseHoldValue(temp.October.auto.value, temp.October.hhs.value)
						: 0
				},
				fire: {
					id: 'fire',
					value: temp.October.hhs.value
						? houseHoldValue(temp.October.fire.value, temp.October.hhs.value)
						: 0
				},
				life: {
					id: 'life',
					value: temp.October.hhs.value
						? houseHoldValue(temp.October.life.value, temp.October.hhs.value)
						: 0
				},
				health: {
					id: 'health',
				...
				total: {
					id: 'total',
					value: temp.October.hhs.value
						? houseHoldValue(temp.October.total.value, temp.October.hhs.value)
						: 0
				}
			},
			November: {
