...
function Dashboard(props) {
	...
	const production = useSelector(({ dashboardApp }) => dashboardApp.products.production);
	const period = useSelector(({ dashboardApp }) => dashboardApp.products.period);	
	const report = useSelector(({ dashboardApp }) => dashboardApp.products.report);
	const user = useSelector(({ dashboardApp }) => dashboardApp.products.user);
