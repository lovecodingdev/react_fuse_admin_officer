...
import { getTemplateData, removeTemplate } from './store/bonusPlanTemplateSlice';
	...
	return (
		<div className="flex flex-1 items-center justify-between p-4 sm:p-24">
			...
			<ThemeProvider theme={mainTheme}>
				...
				>
					<DialogTitle id="alert-dialog-title">{`Are you really ${action.includes('Save As') ? 'clone' : 'delete'} this template?`}</DialogTitle>
					<DialogContent>
						<DialogContentText id="alert-dialog-description">
							{
								action.includes('Save As') ? 'You will clone this template.' : 'You will lost this template data.'
							}
						</DialogContentText>
